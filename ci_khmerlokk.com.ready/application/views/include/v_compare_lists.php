<table class="table compare-table inner-top-vs">
						...
						<td  id="compare<?php echo $i ?>">
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail">
										    <img alt="" src="<?php echo base_url() ?>assets/images/products/p<?php echo $i ?>.jpg">
										</a>
									</div>
					...
					<tr >
						...
						<td class='text-center' id="compare<?php echo $i ?>">
							<a href="javascript:Remove_Compare(<?php echo $i ?>)" class="remove-icon"><i class="fa fa-times"></i></a>
						</td>
						<?php } ?>
					</tr>
				</table>
